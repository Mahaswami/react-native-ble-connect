...
public class Peripheral extends BluetoothGattCallback {
   ...
   private final LocationListener locationListener = new LocationListener() {
        ...
        public void onLocationChanged(final Location location) {
            System.out.println("PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPlocation");
   ...
   public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
      ...
      System.out.println("************@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ BleManagerDidUpdateValueForCharacteristic");
      sendEvent("BleManagerDidUpdateValueForCharacteristic", map);
        ...
        try {
            ...
            if (latitude != 0) {
                String queryString = "?userId=" + userId + "&latitude=" + latitude + "&longitude=" + longitude + "&altitude=" + altitude;
                String urlString = proxyUrl + queryString;
                System.out.println("QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQq");
                System.out.println(urlString);

                //String urlString = "http://192.168.2.15:7070/trigger_immediate_alert/" + userId + "/" + latitude + "/" + longitude + "/" + altitude;
   ...
   public void registerNotify(int userId, String proxyUrl, UUID serviceUUID, UUID characteristicUUID, Callback callback) {
      ...
      //
        ...
        try {
            System.out.println("lllllllllllllllllllllllllllllocation manager");
